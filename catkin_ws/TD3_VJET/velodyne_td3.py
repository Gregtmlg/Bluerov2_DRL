...
file_name = "TD3_bluerov"  # name of the file to store the policy
...
env = GazeboEnv('bluerov2_scenario.launch', 1, 1, 1)
time.sleep(5)
# env.seed(seed)
...
while timestep < max_timesteps:
    ...
    if done:
        ...
        if timesteps_since_eval >= eval_freq:
            ...
            evaluations.append(evaluate(network, eval_ep, epoch))
